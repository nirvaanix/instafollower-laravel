...
@section('title', '@' . $account->username . ' — InstaFollower')
    ...
    <section class="profile-page">
            ...
            <div class="profile-hero-content">
                ...
                <div class="profile-avatar-wrapper">
                    @if($account->profile_picture_url)
                        <img src="{{ $account->profile_picture_url }}" alt="{{ $account->username }}" class="profile-page-avatar">
                    @else
                ...
                @if($account->bio)
                    <p class="profile-page-bio">{{ $account->bio }}</p>
                @endif

                {{-- Follower Count Showcase --}}
                ...
                <div class="profile-stats-row">
                    <div class="profile-stat">
                        <div class="profile-stat-value">{{ number_format($account->followers_count) }}</div>
                        <div class="profile-stat-label">Followers</div>
                    </div>
                    <div class="profile-stat-divider"></div>
                    <div class="profile-stat">
                        <div class="profile-stat-value">{{ number_format($account->media_count) }}</div>
                    ...
                    <div class="profile-stat">
                        <div class="profile-stat-value">
                            @if($account->connected_at)
                                {{ $account->connected_at->format('M Y') }}
                            @else
                                —
                            @endif
                        </div>
                ...
                {{-- View on Instagram --}}
                <a href="https://instagram.com/{{ $account->username }}" target="_blank" rel="noopener" class="btn btn-instagram-link">
        ...
        <div class="data-source-badge">
            ...
            @if($account->last_sync)
                &middot; Synced {{ $account->last_sync->diffForHumans() }}
            @endif
        </div>
        ...
        @if($isOwner)
            <div class="owner-actions glass-card">
                ...
                <p class="owner-share-text">Share this profile:</p>
                <div class="share-link-box">
                    <code id="share-url">{{ url('/' . $account->username) }}</code>
